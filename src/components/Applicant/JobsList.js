...
class JobsList extends Component {
    ...
    onSOPsubmit(job)
    {
        ...
        {
            axios
                .post('https://jobplanet12.herokuapp.com/application/add_application', newApplication)
                .then(response => {
            ...
            axios
                .put('https://jobplanet12.herokuapp.com/user/edit_profile/' + user.id, editApplicant)
                .then(response => {
