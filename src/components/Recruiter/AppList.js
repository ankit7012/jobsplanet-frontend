...
class AppList extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://jobplanet12.herokuapp.com/user/'+ user.id)
                .then(response => {
        ...
        axios.get('https://jobplanet12.herokuapp.com/job/get_jobs')
            .then(response => {
        ...
        axios.get('https://jobplanet12.herokuapp.com/user/')
            .then(response => {
        ...
        axios.get('https://jobplanet12.herokuapp.com/application/get_applications')
            .then(response => {
    ...
    shortlist(application) {
        ...
        axios
            .put('https://jobplanet12.herokuapp.com/application/edit_application/' + application._id, editApplication)
            .then(response => {
    ...
    accept(application) {
        ...
        else if(job.numpos === job.posmax - 1)
        {
            this.state.applications.filter(item => item.applicantId !== application.applicantId && item.jobId === application.jobId && item.status !== "Deleted" && item.status !== "Accepted").forEach(
                function(appli)
                {
                    ...
                    // }
                    axios
                        .put('https://jobplanet12.herokuapp.com/application/edit_application/' + appli._id, tempAppli)
                        .then(response => {
        ...
        axios
            .put('https://jobplanet12.herokuapp.com/job/edit_job/' + job._id, editJob)
            .then(response => {
                console.log(editJob);
            })
            .catch(function(error) {
        ...
        axios
            .put('https://jobplanet12.herokuapp.com/user/edit_profile/' + application.applicantId, editApplicant)
            .then(response => {
        ...
        this.state.applications.filter(item => item.applicantId === application.applicantId && item._id !== application._id && item.status !== "Deleted").forEach(
            function(appli)
            {
                ...
                // }
                axios
                    .put('https://jobplanet12.herokuapp.com/application/edit_application/' + appli._id, editAppli)
                    .then(response => {
