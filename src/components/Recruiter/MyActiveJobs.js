...
class MyActiveJobs extends Component {
    ...
    deljob(id) {
        ...
        axios
            .delete('https://jobplanet12.herokuapp.com/job/del_job/' + id)
            .then(response => {
        ...
        applicationsArray.filter(item => item.jobId === id && item.status === "Accepted").forEach(
            function(appli) 
            {
                ...
                axios
                    .put('https://jobplanet12.herokuapp.com/user/edit_profile/' + appli.applicantId, editEmployee)
                    .then(response => {
        ...
        applicationsArray.filter(item => item.jobId === id).forEach(
            function(appli) 
            {
                ...
                axios
                    .put('https://jobplanet12.herokuapp.com/user/edit_profile/' + appli.applicantId, editApplicant)
                    .then(response => {
    ...
    editJobSubmit(job) {
        ...
        else
        {
            ...
            axios
                .put('https://jobplanet12.herokuapp.com/job/edit_job/' + idToChange, this.state.jobs[ind])
                .then(response => {
